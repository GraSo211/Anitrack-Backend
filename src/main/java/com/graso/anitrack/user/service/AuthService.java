...
import com.graso.anitrack.user.client.myanimelist.MyAnimeListAuthClient;
...
public class AuthService {
    ...
    private final MyAnimeListAuthClient authClient;
    private final String clientId;
    private final String backendUrl;
    private final OAuthStateStore stateStore;

    public AuthService(
            MyAnimeListAuthClient authClient,
    ...
    public ResponseTokenRequest loginWithMyAnimeList(
        ...
        return authClient.loginUser(code, codeVerifier);
    }
